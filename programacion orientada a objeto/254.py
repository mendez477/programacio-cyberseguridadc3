...
class aplicacion:
    def __init__(self):
        self.ventana1=tk.Tk()
        self.canvas1=tk.Canvas(self.ventana1, width=60, height=400, background="black")
        ...
        self.canvas1.create_arc(420,10,550,110, fill="yeloow", start=180, extent=90)
        self.canvas1.create_rectangle(150,210,250,310, outline="red")
